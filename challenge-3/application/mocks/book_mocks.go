...
func (_m *BookMocks) Create(newBook *book.Book) (*book.Book, error) {
...
func (_m *BookMocks) Delete(id int) error {
	ret := _m.Called(id)
...
func (_m *BookMocks) GetAll(page int64, limit int64) (*postgresbook.PaginationResultBook, error) {
...
func (_m *BookMocks) GetByID(id int) (*book.Book, error) {
	ret := _m.Called(id)
...
func (_m *BookMocks) GetOneByMap(bookMap map[string]interface{}) (*book.Book, error) {
...
func (_m *BookMocks) Update(id uint, bookMap map[string]interface{}) (*book.Book, error) {
...
func (_m *BookMocks) UserGetAll(page int64, userId int, limit int64) (*postgresbook.PaginationResultBook, error) {
...
func (_m *BookMocks) UserGetByID(id int, userId int) (*book.Book, error) {
