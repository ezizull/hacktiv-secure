...
func (_m *Service) Get(_a0 int) (*user.User, error) {
	ret := _m.Called(_a0)
...
func (_m *Service) GetByID(_a0 int) (*user.User, error) {
	ret := _m.Called(_a0)
...
func (_m *Service) GetByMap(_a0 map[string]interface{}) map[string]interface{} {
	ret := _m.Called(_a0)
...
func (_m *Service) Update(_a0 int, _a1 map[string]interface{}) (*user.User, error) {
